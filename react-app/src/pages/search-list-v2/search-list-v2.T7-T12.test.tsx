...
it('T0012: Check 更新 form functionality 更新 - It should make 3 API calls in order: Check integrity, Update Record, and get all records', async () => {
  ...
  if (tableWrapper) {
    ...
    // Find the edit button (pencil icon) in the action column
    const confirmButton = await modalContent.findByRole('button', { name: /更 新/i });
    ...
    await waitFor(() => {
      ...
      expect(mockCheckIntegrity).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          materialDepartmentCode: "test",
          groupCorporateCode: "test",
          previousFactoryName: "long test",
          productFactoryName: "long test",
          environmentalInformation: "long test",
          authenticationFlag: "long test",
          integrationPattern: "long test",
          hulftid: "long test",
        })
      );
      ...
      expect(mockUpdateRecord).toHaveBeenCalledWith(expect.objectContaining({
        materialDepartmentCode: "test",
        groupCorporateCode: "test",
        previousFactoryName: "long test",
        productFactoryName: "long test",
